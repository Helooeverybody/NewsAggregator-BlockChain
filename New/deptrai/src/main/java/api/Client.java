...
public class Client {
	...
	public List<Integer> search(List<String> keywords) throws IOException, InterruptedException {
		HttpClient client = HttpClient.newHttpClient();
		String encodedKeyword = URLEncoder.encode(keywords.get(0), StandardCharsets.UTF_8);
	...
	public List<String> trend(List<String> trendsList) throws IOException, InterruptedException{
